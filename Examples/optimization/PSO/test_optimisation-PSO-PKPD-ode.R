...
# evaluationPopFIM = Evaluation( name = "PKPD_ODE_populationFIM",
...
outputFile = paste0("Optimization_PSO_PKPD_ode_populationFIM.html")
Report( optimizationPopFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("Optimization_PSO_PKPD_ode_individualFIM.html")
Report( optimizationIndFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("Optimization_PSO_PKPD_ode_bayesianFIM.html")
