...
evaluationPopFIM = Evaluation( name = "PKPD_ODE_1_dose_populationFIM",
...
evaluationIndFIM = Evaluation( name = "PKPD_ODE_1_dose_individualFIM",
                               modelEquations = modelEquations,
                               modelParameters = modelParameters,
                               modelError = modelError,
                               outcomes = list( "RespPK" = "Cc", "RespPD" = "E"),
...
evaluationBayeFIM = Evaluation( name = "PKPD_ODE_1_dose_bayesianFIM",
                                modelEquations = modelEquations,
                                modelParameters = modelParameters,
                                modelError = modelError,
                                outcomes = list( "RespPK" = "Cc", "RespPD" = "E"),
...
outputFile = paste0("PKPD_ODE_1_dose_populationFIM.html")
Report( evaluationPopFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPD_ODE_1_dose_individualFIM.html")
Report( evaluationIndFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPD_ODE_1_dose_bayesianFIM.html")
