...
evaluationPopFIM = Evaluation( name = "PKPKPD_ODE_Infusion_1_dose_populationFIM",
...
evaluationIndFIM = Evaluation( name = "PKPKPD_ODE_Infusion_1_dose_individualFIM",
                               modelEquations = modelEquations,
                               modelParameters = modelParameters,
                               modelError = modelError,
                               outcomes = list( "RespPK1"="C1", "RespPK2"= "C2", "RespPD" = "E" ),
...
evaluationBayeFIM = Evaluation( name = "PKPKPD_ODE_Infusion_1_dose_bayesianFIM",
                                modelEquations = modelEquations,
                                modelParameters = modelParameters,
                                modelError = modelError,
                                outcomes = list( "RespPK1"="C1", "RespPK2"= "C2", "RespPD" = "E" ),
...
outputFile = paste0("PKPKPD_ODE_Infusion_1_dose_populationFIM.html")
Report( evaluationPopFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPKPD_ODE_Infusion_1_dose_individualFIM.html")
Report( evaluationIndFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPKPD_ODE_Infusion_1_dose_bayesianFIM.html")
