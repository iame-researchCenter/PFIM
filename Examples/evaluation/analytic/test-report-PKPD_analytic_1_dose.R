...
evaluationPopFIM = Evaluation( name = "PKPD_analytic_1_dose_populationFIM",
...
evaluationIndFIM = Evaluation( name = "PKPD_analytic_1_dose_individualFIM",
                               modelEquations = modelEquations,
                               modelParameters = modelParameters,
                               modelError = modelError,
                               outcomes = list( "RespPK", "RespPD"),
...
evaluationBayeFIM = Evaluation( name = "PKPD_analytic_1_dose_bayesianFIM",
                               modelEquations = modelEquations,
                               modelParameters = modelParameters,
                               modelError = modelError,
                               outcomes = list( "RespPK", "RespPD"),
...
outputFile = paste0("PKPD_analytic_1_dose_populationFIM.html")
Report( evaluationPopFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPD_analytic_1_dose_individualFIM.html")
Report( evaluationIndFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPD_analytic_1_dose_bayesianFIM.html")
