...
evaluationPopFIM = Evaluation( name = "PKPD_analytic_infusion_repetead_doses_populationFIM",
...
evaluationIndFIM = Evaluation( name = "PKPD_analytic_infusion_repetead_doses_individualFIM",
                               modelEquations = modelEquations,
                               modelParameters = modelParameters,
                               modelError = modelError,
                               outcomes = list( "RespPK", "RespPD"),
...
evaluationBayeFIM = Evaluation( name = "PKPD_analytic_infusion_repetead_doses_bayesianFIM",
                                modelEquations = modelEquations,
                                modelParameters = modelParameters,
                                modelError = modelError,
                                outcomes = list( "RespPK", "RespPD"),
...
outputFile = paste0("PKPD_analytic_infusion_repetead_doses_populationFIM.html")
Report( evaluationPopFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPD_analytic_infusion_repetead_doses_individualFIM.html")
Report( evaluationIndFIM, saveReportPath, outputFile, plotOptions )

outputFile = paste0("PKPD_analytic_infusion_repetead_doses_bayesianFIM.html")
